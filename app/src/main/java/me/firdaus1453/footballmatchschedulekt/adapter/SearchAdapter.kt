...
class SearchAdapter(private val teams: List<EventItem>, private val listener: (EventItem) -> Unit) : RecyclerView.Adapter<SearchAdapter.TeamViewHolder>() {
    override fun onBindViewHolder(p0: SearchAdapter.TeamViewHolder, p1: Int) = p0.bindItem(teams[p1], listener)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TeamViewHolder =
        TeamViewHolder(TeamUISearch().createView(AnkoContext.create(parent.context, parent)))
    ...
    class TeamViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(teams: EventItem, listener: (EventItem) -> Unit) {
...
class TeamUISearch : AnkoComponent<ViewGroup> {
